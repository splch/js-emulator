...
// Build keybindings object using defaultKeys
let keyBindings = {};
...
let btnA = document.getElementById("controller_a");
let btnB = document.getElementById("controller_b");
let btnStart = document.getElementById("controller_start");
let btnSelect = document.getElementById("controller_select");
let dpad = document.getElementById("controller_dpad");
